...
def get_review_bias(score, baseline, user_bias, business_bias):
    return score - baseline - business_bias - user_bias
...
with open(r"dataset\review.json", 'r', encoding='utf-8') as f:
    for line in f:
        ...
        if selected_city == business_id2city[business_id]:
...
word2rating = dict()
for business in category2business2reviews[selected_category]:
    business_word2rating = dict()
    for review in category2business2reviews[selected_category][business]:
...
for business in category2business2reviews[selected_category]:
    business_word2rating = dict()
    category_reviews += category2business2reviews[selected_category][business]

    print("\n" + business_id2name[business] + "\n")
    classify_using_NaiveBayes(category2business2reviews[selected_category][business])
