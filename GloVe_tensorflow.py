...
class GloVeModel():
    def __init__(self, embedding_size, context_size, max_vocab_size=500000, min_occurrences=1,
                 scaling_factor=3/4, cooccurrence_cap=100, batch_size=512, learning_rate=0.025):
